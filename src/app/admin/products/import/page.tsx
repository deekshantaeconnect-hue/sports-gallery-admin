...
const TARGET_FIELDS = [
  ...
  { name: "store", label: "Store Name", required: false, type: "text", example: `${BRAND.name}` },
  { name: "brand", label: "Brand", required: false, type: "text", example: `${BRAND.name}` },
  ...
  { name: "manufacturer", label: "Manufacturer", required: false, type: "text", example: `${BRAND.fullname}` },
