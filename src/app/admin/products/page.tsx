...
export default function AdminProductsPage() {
  ...
  return (
    <div
      className="p-4 md:p-8 max-w-[1600px] mx-auto animate-in fade-in duration-300  min-h-screen"
            ...
            <>
              {paginatedData.map((p: any) => {
                ...
                return (
                  <div
                    key={p.id}
                    className="bg-white rounded-2xl p-4 border border-gray-200 shadow-sm flex flex-col gap-4"
                  >
                    <div className="flex gap-4 items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm font-black text-gray-900 mt-2">
                          ₹
                          {p.variants?.[0]?.price?.toLocaleString("en-IN") || 0}
                        </p>
                      </div>
                    </div>
